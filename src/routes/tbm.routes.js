...
router.put('/reject-sales-rep/:id', TBMController.rejectSalesRepTarget);
...
router.post('/territory-targets/save', validateBody(saveTerritoryTargetsSchema), TBMController.saveTerritoryTargets);
