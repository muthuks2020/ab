...
router.get('/products', authorize('sales_rep', 'tbm', 'abm', 'zbm', 'sales_head', 'at_iol_specialist', 'eq_spec_diagnostic', 'eq_spec_surgical', 'at_iol_manager', 'eq_mgr_diagnostic', 'eq_mgr_surgical'), SalesRepController.getProducts);
...
router.get('/salesrep/dashboard-summary', authorize('sales_rep', 'at_iol_specialist', 'eq_spec_diagnostic', 'eq_spec_surgical', 'at_iol_manager', 'eq_mgr_diagnostic', 'eq_mgr_surgical'), SalesRepController.getDashboardSummary);
router.get('/salesrep/quarterly-summary', authorize('sales_rep', 'at_iol_specialist', 'eq_spec_diagnostic', 'eq_spec_surgical', 'at_iol_manager', 'eq_mgr_diagnostic', 'eq_mgr_surgical'), SalesRepController.getQuarterlySummary);
router.get('/salesrep/category-performance', authorize('sales_rep', 'at_iol_specialist', 'eq_spec_diagnostic', 'eq_spec_surgical', 'at_iol_manager', 'eq_mgr_diagnostic', 'eq_mgr_surgical'), SalesRepController.getCategoryPerformance);
